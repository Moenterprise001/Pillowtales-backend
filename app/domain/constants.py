...
VOICE_PRESETS: Dict[str, Dict[str, Any]] = {
    'wise_owl': {'provider': 'openai', 'voice_id': 'fable', 'name': 'Wise Owl', 'description': 'Calm British bedtime narration, trusting, loving and gentle', 'icon': '🦉', 'language_code': 'en', 'tier': 'free'},
    'night_owl_english': {'provider': 'openai', 'voice_id': 'shimmer', 'name': 'Night Owl', 'description': 'Warm American bedtime narration, calm and reassuring', 'icon': '🦉', 'language_code': 'en', 'tier': 'free'},
