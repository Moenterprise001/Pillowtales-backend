...
VOICE_PRESETS: Dict[str, Dict[str, Any]] = {
    'wise_owl': {'provider': 'openai', 'voice_id': 'ballad', 'name': 'Wise Owl', 'description': 'Calm British bedtime narration, gentle and reassuring', 'icon': '🦉', 'language_code': 'en', 'tier': 'free'},
