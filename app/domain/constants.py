...
VOICE_PRESETS: Dict[str, Dict[str, Any]] = {
    'wise_owl': {'provider': 'openai', 'voice_id': 'shimmer', 'name': 'Wise Owl', 'description': 'Calm British bedtime narration, trusting, loving and gentle', 'icon': '🦉', 'language_code': 'en', 'tier': 'free'},
